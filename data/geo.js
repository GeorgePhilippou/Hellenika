...
export const territories = [
  ...
  {
    id: 't-alex-levant', name: "Alexander's empire: the Levant", label: "Alexander's empire",
    kind: 'polity', tint: 'alexander', from: -332, to: -323,
    ring: [[36.2, 36.4], [38.5, 36.0], [39.0, 34.0], [37.0, 32.0], [35.7, 31.3],
           [34.6, 32.2], [35.0, 33.5], [35.6, 34.6]],
  },
  {
    id: 't-alex-egypt', name: "Alexander's empire: Egypt", label: "Alexander's empire",
    kind: 'polity', tint: 'alexander', from: -332, to: -323,
    ring: [[35.7, 31.3], [33.4, 31.2], [32.5, 29.0], [32.0, 24.0],
           [30.5, 23.0], [29.5, 24.0], [29.2, 28.0], [29.0, 31.4], [32.0, 31.4],
           [34.6, 32.2]],
  },
  {
    id: 't-alex-mesopotamia', name: "Alexander's empire: Mesopotamia",
    label: "Alexander's empire", kind: 'polity', tint: 'alexander',
    from: -331, to: -323,
    ring: [[38.5, 37.5], [43.0, 38.0], [47.5, 38.0], [50.0, 35.0], [49.0, 29.0],
           [47.0, 30.2], [44.5, 31.5], [41.0, 33.5], [38.8, 34.5]],
  },
  {
    id: 't-alex-persia', name: "Alexander's empire: Persia", label: "Alexander's empire",
    kind: 'polity', tint: 'alexander', from: -330, to: -323,
    ring: [[47.0, 39.0], [51.0, 37.0], [55.0, 36.0], [57.0, 33.0], [58.0, 29.0],
           [56.5, 27.0], [53.0, 27.0], [49.0, 29.0], [47.0, 30.2], [48.0, 34.0]],
  },
  {
