...
survival: Four speeches
claims:
  - text: Demosthenes delivered a series of speeches against Philip II between 351 and 341 BC.
    evidence: literary
    confidence: established
  - text: He argued that Athens must fund and serve in campaigns directly rather than rely on mercenaries.
    evidence: literary
    confidence: established
  - text: The term "philippic" became a generic name for a denunciatory speech.
    evidence: consensus
    confidence: established
