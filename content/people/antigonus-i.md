...
coords:
  - 38.5
  - 30.5
region: Phrygia, Anatolia
claims:
  - text: Antigonus served Alexander as satrap of Phrygia and became the most powerful of the successors in Asia after 320 BC.
    evidence: literary
    confidence: established
  - text: In 306 BC, after his son Demetrius destroyed Ptolemy's fleet off Cyprian Salamis, Antigonus was the first successor to take the title of king.
    evidence: literary
    confidence: established
  - text: A coalition of Ptolemy, Seleucus, Lysimachus and Cassander combined against him.
    evidence: literary
    confidence: strong
...
<!-- field: summary -->
The most powerful of Alexander's successors in Asia, first of them to claim the title of king, killed fighting at Ipsus in 301 BC.

<!-- field: significance -->
His bid to reunite Alexander's empire under himself was the single greatest threat to the partition into separate kingdoms, and the coalition that finally defeated him at Ipsus set the borders of the Hellenistic world for a generation.

<!-- field: body -->
Antigonus lost an eye at some point during Philip II's campaigns, and the nickname stuck for the rest of his long life. As satrap of Phrygia under Alexander he was a secondary figure; after the settlements following Alexander's death fell apart into open war, he emerged by the 310s as the dominant power in Asia, controlling territory and resources no other successor could match.
