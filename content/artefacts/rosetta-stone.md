...
claims:
  - text: The stone records a priestly decree of 196 BC in hieroglyphic, Demotic and Greek.
    evidence: epigraphic
    confidence: established
  - text: It was found by French forces in 1799 and transferred to Britain in 1801.
    evidence: consensus
    confidence: established
  - text: Champollion used it to demonstrate that hieroglyphs are a mixed phonetic and semantic system in 1822.
    evidence: linguistic
    confidence: established
...
relations:
  ...
  - id: hellenistic-period
    rel: period
  - id: alexandria
    rel: administered from
  - id: linear-b
    rel: decipherment parallel
sources:
  - parkinson1999
  - robinson2002
_order: 51
