...
coords:
  - 37.976
  - 23.726
material: Bronze original (lost); Roman marble copies
museum: Palazzo Massimo, Rome; British Museum
claims:
  - text: The Discobolus is known only from Roman copies of a lost Greek bronze by Myron.
    evidence: consensus
    confidence: established
  - text: Almost all large Greek bronzes were lost to melting down.
    evidence: consensus
    confidence: established
  - text: Marble copies require structural supports absent in the bronze original.
