...
coords:
  - 40.762
  - 22.523
material: Cornel wood, iron, bronze
museum: 'Fragments: Vergina, Pella'
claims:
  - text: The sarissa was a two-handed pike substantially longer than a hoplite spear.
    evidence: literary
    confidence: established
  - text: Iron sarissa fittings including joining sleeves have been excavated in Macedon.
    evidence: archaeological
    confidence: strong
  - text: Its use required a smaller shield strapped to the arm.
    evidence: literary
    confidence: strong
  - text: Pikes of the first several ranks projected beyond the front of the formation.
    evidence: literary
    confidence: strong
