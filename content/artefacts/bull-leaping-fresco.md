...
claims:
  - text: Minoan art repeatedly depicts humans vaulting over bulls.
    evidence: archaeological
    confidence: established
  - text: The surviving fresco is heavily reconstructed from small fragments.
    evidence: archaeological
    confidence: established
  - text: Skin colour conventions in the fresco distinguish male and female figures.
    evidence: consensus
    confidence: strong
