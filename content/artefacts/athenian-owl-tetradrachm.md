...
museum: Worldwide
claims:
  - text: Athenian tetradrachms were struck from Laurion silver with consistent weight and purity.
    evidence: numismatic
    confidence: established
  - text: They circulated widely across the Mediterranean and Near East.
    evidence: numismatic
    confidence: established
  - text: The design was kept deliberately archaic for recognisability.
    evidence: consensus
    confidence: strong
  - text: Athens required subject allies to use Athenian coinage and measures.
    evidence: epigraphic
    confidence: strong
