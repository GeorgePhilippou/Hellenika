...
coords:
  ...
  - 27.277
claims:
  - text: Ionian Greek cities revolted against Persian rule from 499 to 493 BC.
    evidence: literary
    confidence: established
  - text: Athens and Eretria sent naval support to the rebels.
    evidence: literary
    confidence: strong
  - text: Sardis was burned during the revolt.
    evidence: literary
    confidence: strong
