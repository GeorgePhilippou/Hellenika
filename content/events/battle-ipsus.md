...
coords:
  ...
  - 31.1
combatants:
  - Seleucus I, Lysimachus, Cassander
  - Antigonus I and Demetrius
outcome: Antigonus killed; unified empire permanently ended
claims:
  - text: Antigonus I was defeated and killed at Ipsus in 301 BC.
    evidence: literary
    confidence: established
  - text: Seleucus deployed around 400 war elephants obtained from India.
    evidence: literary
    confidence: strong
  - text: The elephants prevented Demetrius' cavalry from rejoining the battle.
    evidence: literary
    confidence: strong
  - text: The battle ended prospects of reuniting Alexander's empire.
    evidence: consensus
    confidence: strong
relations:
  - id: seleucus-i
...
Antigonus, aged around 80, was left unsupported and killed by javelins, reportedly still expecting his son to return. With him died the last realistic prospect of a single empire.
