---
id: obsidian-trade
name: The Melian obsidian trade
type: event
subtype: process
tint: earlybronze
start: -11000
...
coords:
  ...
  - 24.42
claims:
  - text: Melian obsidian reached the Greek mainland by c. 11,000 BC.
    evidence: archaeological
    confidence: established
  - text: Obsidian can be chemically traced to its source volcano.
    evidence: archaeological
    confidence: established
  - text: Its presence at Franchthi Cave demonstrates open-water voyaging.
    evidence: archaeological
    confidence: strong
relations:
  - id: early-bronze-age
