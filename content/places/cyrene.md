...
region: Libya
claims:
  - text: Cyrene was founded from Thera around 631 BC.
    evidence: literary
    confidence: strong
  - text: Its economy depended heavily on the export of silphium.
    evidence: numismatic
    confidence: established
  - text: Silphium became extinct by the 1st century AD.
    evidence: literary
    confidence: strong
  - text: Silphium could not be successfully cultivated outside its native range.
    evidence: literary
    confidence: probable
...
<!-- field: summary -->
A Greek colony in North Africa that grew rich on silphium, a medicinal plant harvested to extinction.
