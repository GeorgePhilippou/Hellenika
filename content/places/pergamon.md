...
region: Mysia
claims:
  - text: Pergamon was the Attalid capital, built in terraces up a steep acropolis.
    evidence: archaeological
    confidence: established
  - text: The Great Altar frieze depicts the battle of gods and giants in high relief.
    evidence: archaeological
    confidence: established
  - text: Attalus III bequeathed the kingdom to Rome in 133 BC.
    evidence: epigraphic
    confidence: established
  - text: Parchment takes its name from Pergamon.
    evidence: linguistic
    confidence: strong
...
<!-- field: summary -->
Attalid capital on a steep acropolis, with the steepest theatre in the ancient world, a great altar, and a library that rivalled Alexandria's.
